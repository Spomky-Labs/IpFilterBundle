...
class appAppKernelTestDebugContainer extends Container
{
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.test' => ($this->privates['.security.request_matcher.3UEFixr'] ?? ($this->privates['.security.request_matcher.3UEFixr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/')));
        }, 1));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SpomkyLabsIpFilterBundle' => 'SpomkyLabs\\IpFilterBundle\\SpomkyLabsIpFilterBundle',
                'SpomkyLabsTestIpFilterBundle' => 'SpomkyLabs\\TestIpFilterBundle\\SpomkyLabsTestIpFilterBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'SpomkyLabsTestIpFilterBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/TestIpFilterBundle'),
            ...
            'sl_ip_filter.ip.class' => 'SpomkyLabs\\TestIpFilterBundle\\Entity\\Ip',
            'sl_ip_filter.range.class' => 'SpomkyLabs\\TestIpFilterBundle\\Entity\\Range',
            'console.command.ids' => [
